...
export default function Page2() {
  ...
  function createNew() {
    // const [name, color, icon] = prompt("Name..")
  ...
  return (
    <>
      <Page3 />
      <div className="w-[282px] mt-14 ml-10 rounded-sm border-black gap-6 ">
        <div className=" flex grid-cols-2 mb-20 ">
          <div className="mx-auto p-10"> Records
            <Button onClick={createNew}>Add
              <AddRecord/>
            </Button>
      ...
      <Button variant="secondary" onClick={() => setOpen(true)}> Add new
      </Button>
...
<Dialog open={open}>
  <DialogContent className="sm:max-w-[700px]">
    <DialogTitle className="my-2 text-xl">Add record</DialogTitle>
    <hr></hr>
